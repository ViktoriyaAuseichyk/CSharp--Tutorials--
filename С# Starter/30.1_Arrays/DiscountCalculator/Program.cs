        ...
        static void Main(string[] args)
        {
            bool userAuthorized; // = AuthorizeUser();
            {
                ...
                while (counter < 3)
                {
                    ...
                    userAuthorized = ("Админ" == login && "000" == password) ||
                                     ("Иванова" == login && "111" == password) ||
                                     ("Петрова" == login && "222" == password) ||
                                     ("Сергеева" == login && "333" == password) ||
                                     ("Васильева" == login && "444" == password) ||
                                     ("Семёнова" == login && "555" == password);
